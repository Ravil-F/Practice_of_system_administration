...
- touch <flag> <name> - создание файлов, а также изменение некоторых мета-данных, например даты и время создания файла. Например -t - позволяет поставить мета-данные (дату и время), -r - присваиваем одному файлу мета-данные другому.
<div align="center">
    <img src="./img/4.JPG" alt="touch">
</div>

- mkdir - создание каталогов. -p - флаг, позволяющий создавать несколько каталогов сразу.
<div align="center">
    <img src="./img/5.JPG" alt="mkdir">
</div>

- rmdir - удаление каталов. У него есть флаги, например, для удаление подкаталога.
- cp <file1> <file2> - скопироет содержимое файла с <file1> в <file2>, а так же создаст файл <file2>, если она не была создана.
- mv <name> - перемещение/переименование файла/каталога.